...
public class FirstTests {
    ...
    @Test
    public void goToPodcastAndSelectThirdOneAndPlayIt(){
...
//            highlightElement(driver,podcast);
  //      }
        ...
        thirdPodcast.click();
        WebElement recordBtn = driver.findElement(By.id("record"));
        recordBtn.click();

        wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.className("status-message"))));
        String recordBtnClassAtrribute = recordBtn.getAttribute("class");

        boolean isPlaying = recordBtnClassAtrribute.contains("playing");
